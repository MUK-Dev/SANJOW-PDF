...
const PrivacyPolicies: FC = () => (
  <Stack w="100%" py="1em" px={{ base: '1em', md: '2em' }} gap="1em">
    <Text>
      Gerlior LTD is a company incorporated under Cyprus law registered with the
      Cyprus Trade and company registered number HE 382120, having its
      registered office at Agiou Pavlous, 115, Agios Dometios, 2362, Nicosia,
      Cyprus (« We PDF », Or « we »).
    </Text>
    <Text>PREAMBLE</Text>
    <Text>
      In operating the <Link href="https://we-pdf.com">we-pdf.com</Link> site,
      Eudialyte Gerlior LTD is required to process data collected during
      navigation on the site. Eudialyte Gerlior LTD is committed to respecting
      the law and taking the necessary measures to respect the privacy of users
      and to protect the data collected.
    </Text>
    <Text>OBJECT</Text>
    <Text>
    ...
    <Text>
      ...
      throughout the customer journey on{' '}
      <Link href="https://we-pdf.com">we-pdf.com</Link>. Thus, the user's
      personal data will be collected and processed during registration,
      payment, navigation and more generally throughout the actions carried out
      on <Link href="https://we-pdf.com">we-pdf.com</Link>. We PDF may collect
      personal data from the user only with prior consent. Here are examples of
    ...
    <Text>
      We PDF collects the personal data of its users for:
      <br />
      ...
      simultaneously by the customer service of{' '}
      <Link href="https://we-pdf.com">we-pdf.com</Link> as well as certain
      subcontractors and business partners. We PDF may authorize the
    ...
    <Text>
      ...
      right of rectification must be addressed to contact@
      <Link href="https://we-pdf.com">we-pdf.com</Link> and accompanied by an
      identity document signed in copy.
    </Text>
    <Text>COOKIES AND TRACKERS</Text>
    <Text>
      We PDF uses cookies, you can consult our Cookies policy on the dedicated
      page.
    </Text>
  </Stack>
);
