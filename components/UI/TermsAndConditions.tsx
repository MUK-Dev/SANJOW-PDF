...
const TermsAndConditions: FC = () => (
  <Stack w="100%" py="1em" px={{ base: '1em', md: '2em' }} gap="1em">
    <Text>
      ...
      This site is owned and operated by Gerlior LTD with the company register
      number HE 382120, having its registered office at Agiou Pavlous, 115,
    ...
    <Text>
      ...
      in the plural, have the following meaning:
    </Text>
    ...
    <Text>
      ...
      <br />
      “Site”: refers to the online electronic service published by the Company,
      accessible at the address{' '}
      <Link href="https://we-pdf.com">we-pdf.com</Link>, as well as all related
      elements.
      <br />
      ...
      through the Site.
      <br />
      “Conversion”: designates one of the functions for changing the format from
      one document to another offered by the Site.
      <br />
      ...
      <br />
      “Online assistance”: refers to all the assistance services made available
      to Members such as operators whose mission is to assist Members for any
      request made through a telephone exchange, e- mail or via the contact page
      of our Site.
      <br />
      ...
      indefinite period from the validation by the Company. This subscription is
      non-binding and can be canceled at any time by the Member.
      <br />
      ...
      <br />
      “Promotional offer”: refers to unlimited access to the Services offered on
      the Website for the duration of the Trial Period. Registration of the
      Member for the Promotional Offer automatically entails the subscription to
      the Subscription. The Promotional Offer allows the Member in particular to
      try the Service before the Subscription is charged
    </Text>
    ...
    <Text>
      ...
      entity on whose behalf you are accessing our Services, and that the latter
      fully accepts T&C.
    </Text>
    ...
    <Text>
      ...
      the procedural steps indicated on the Site. He will fill in all the fields
      allowing him to identify himself, to select the Services and the methods
      of payment. The Member must ensure, before using the Site, that he has the
      technical and IT resources necessary to use the Site, and that his browser
      allows secure access to the Site. The Member must also ensure that the
      computer configuration of his material / equipment is in good condition
    ...
    <Text>
      ...
      access to your Account or any breach of the security of your Account. This
      includes the loss or theft of your login information.
    </Text>
    <Text>4. DESCRIPTION OF SERVICES</Text>
    <Text>
      The Site is an online platform operating by subscription and on which, as
      a Member:
      <br />
      ...
      in the possibility of contacting advisers by telephone, chat or e-mail to
      obtain information on the Site or on the Services.
      <br />
      Edit a PDF document
      <br />
      Merge PDF documents
    ...
    <Text>
      ...
      summary. The member has the possibility to modify the chosen Conversion as
      well as his information before proceeding to the subscription of our
      promotional Offer.
      <br />
      ...
      contract will be concluded with the Company and the Member which will bind
      them to each other.
      <br />
    ...
    <Text>
      ...
      in order to be able to access the Services offered by us. The price of the
      Subscription and of the Trial Period are indicated on the Site in euros
      (€) All taxes included (TTC). They include the amount of VAT applicable on
      the day of subscription.
      <br />
      The Subscription to the Service is concluded for an indefinite period from
      the date of subscription, the Subscription is non-binding and can be
      terminated at any time by the Member.
      <br />
      The amount of the Subscription as well as that of the Trial Period can be
      modified at any time by us. The Member will be informed in advance 10 days
      before the end of your current Subscription, so they will be free to renew
      their Subscription or not.
      <br />
      ...
      bank card transaction made between the Member and the secure payment
      system is encrypted, the Company will never have access to the full number
      of the Member’s bank card. This guarantees the Member the total
      confidentiality of his banking information. The Member guarantees to the
      Company that he has the necessary authorizations to use the method of
    ...
    <Text>
      ...
      <br />
      Following the subscription by the Member to the Trial Period, they will be
      provided with the necessary identifiers to allow them to access their
    ...
    <Text>
      ...
      system, not to use any device, software or other elements that may affect
      ...
      <br />
      The Company reserves the right to remove a Member’s access to the Site and
      to take all legal and criminal measures against him if for any reason the
      Company considers that the Member is not respecting these GTCS.
    </Text>
    <Text>
      10. WAIVER OF THE LEGAL RIGHT OF WITHDRAWAL – CANCELLATION AND REFUND OF A
      SUBSCRIPTION
    </Text>
    <Text>
      No request for a refund of a Subscription will be permitted if received
      after the expiration of fourteen (14) days from the first Subscription to
      the Services.
      <br />
      All requests for refunds prior to the fourteen (14) day expiration period
      may be made by telephone or email to our customer support department.
      Customer Support will respond within 48 hours, and refunds will be
    ...
    <Text>
      ...
      <br />
      Any termination will take effect from the end of the month of the current
      subscription that remains due. From the effective date of termination, the
      Member no longer has access to the Member Area or to the Services.
    </Text>
    <Text>12. RESPONSIBILITY</Text>
    <Text>
      All the measures necessary for the proper provision of the service will be
      put in place by the Company. However, the Company may not be held
      responsible for the poor performance or the non-performance of all or part
      of the Service if this is due to the Member, to the unforeseeable and
      insurmountable fact of a third party foreign to the Order or to a case of
      major force. If the Company were to be held liable, it could not agree to
      compensate the Member for direct or indirect damage without proof being
      established.
      <br />
      All efforts will be made by the Company to allow accessibility to the Site
      24 hours a day, 7 days a week. Under no circumstances can the Company be
      held responsible for unavailability due to constraints due to the
      operation of the Internet, maintenance operations, any failure or bug, any
      event beyond its control or force majeure beyond the reasonable control of
      the Company.
      <br />
      ...
      responsible for the operation, content or any element present or obtained
      through these sites. The presence of these links on the Site should not be
      interpreted as an express or tacit endorsement by the Company of the
      content or services provided by these sites. The company cannot be held
      responsible for the availability of these sites or control their content,
      advertising, products or any other content.
      <br />
      ...
      the summary of the Order or more largely any other e-mail originating from
      the Company, under no circumstances can the Company be held responsible.
    </Text>
    <Text>13. PERSONAL DATA</Text>
    <Text>
      In accordance with the law of January 6, 1978 relating to computers, files
      and freedoms, as amended, the Member is informed that the Company is
      collecting and processing their personal data in order to enable them to
      process and execute his Order (s) placed on the Website.
      <br />
      It is imperative that the Site has access to the following information for
      the ordering process to proceed without blocking: name, first name,
      electronic address (e-mail).
      <br />
      Service providers and in particular hosting providers established outside
      the European Union may have access to Members’ personal data. The Company
      has entered into personal data transfer agreements with these service
      providers comprising standard contractual clauses approved by the European
      Commission.
      <br />
      It is possible for the Member to appeal to a right of opposition,
      rectification, deletion and access to personal data concerning him as well
      as a right of opposition for a legitimate reason exercisable under the
      conditions provided for by law by sending an email to the Company at the
      address contact@
      <Link href="https://we-pdf.com">we-pdf.com</Link> specifying his name,
      first name, email address and order number.
      <br />
      ...
      <br />
      In accordance with CNIL deliberation n ° 2013-378 of December 5, 2013, the
      Company also informs the Member that cookies record certain information
      which is stored in the memory of its hard drive. This information is used
      to generate site audience statistics and to offer Services according to
      the Services they have already selected during their previous visits. A
      warning message, in the form of a banner, asks each person visiting the
      Website, beforehand, if the Member wishes to accept cookies. These cookies
      do not contain confidential information about Members of the Website.
      <br />
      ...
      <br />
      the ability to oppose these cookies and change the settings by clicking on
      a link in the banner.
      <br />
      and the fact that the continuation of its navigation constitutes agreement
      to the deposit of cookies on its terminal.
      <br />
      The Cookies banner will not disappear until the Member has continued
      browsing, this allows us to guarantee the free and informed consent of the
      Member regarding Cookies.
      <br />
      ...
      browsing: a simple lack of action does not could in fact be assimilated to
    ...
    <Text>
      ...
      combination of such elements are the exclusive property of the Company and
      are protected by copyright, trademark law, designs and / or all other
      intellectual property rights. All of these rights are reserved for the
      whole world.
      <br />
      ...
      purpose of the Site.
      <br />
      Questions or comments relating to a site foreign to the Company should be
      addressed to the operators of these sites, all links to this Site are
      ...
      belonging to the Company is strictly prohibited except in the event of the
      Company’s express prior consent.
    </Text>
    <Text>15. APPLICABLE LAW AND ATTRIBUTION OF JURISDICTION</Text>
    <Text>
      These T & Cs are governed by and interpreted in accordance with irish law,
      without taking into account the principles of conflicts of laws.
      <br />
      In the event of a dispute that may arise during the interpretation and /
      or execution of these Terms or in connection with these T & Cs, the Member
      may decide to submit the dispute with the Company to a procedure for
      conventional mediation or any other alternative dispute resolution method.
      The Member may in particular contact the courts of Dublin, Ireland. The
      Member acknowledges that before undertaking any mediation process, he must
      first contact the Company by phone, chat or e-mail at: contact@
      <Link href="https://we-pdf.com">we-pdf.com</Link> in order to assert your
      right to Refund (see 10. Exercise of the “Satisfied or Refunded” option).
      <br />
